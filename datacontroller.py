...
#dataset_nameARG = 'ashaychoudhary/heart-attack-in-youth-vs-adult-in-russia' 
#dataset_fileARG = 'heart_attack_russia_youth_vs_adult.csv'

import boto3
from kaggle.api.kaggle_api_extended import KaggleApi
import os

def source_from_kaggle(dataset_nameARG, dataset_fileARG,bucket):
    #Step 1. Authenticate with Kaggle 
    api = KaggleApi()
    api.authenticate()
    print("Kaggle Authentication 200" , flush = True)

    #Step 2. Specify Dataset File & Bucket
    dataset_name = dataset_nameARG
    dataset_file = dataset_fileARG
